/**
 * tracking.js
 * Captures UTM parameters + referrer once per session, persists them so they
 * survive page-to-page navigation (checkout included), and reports lead
 * events (pageview / whatsapp_click / call_click / checkout) to the backend.
 */
...
// Fire-and-forget — never blocks the UI, never throws into the caller.
