/**
 * storage.js
 * Cart, wishlist, and recently-viewed state — all client-side via
 * localStorage since there's no logged-in customer account in this system
 * (checkout is guest + WhatsApp-first, per spec).
 */
